!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], t)
    : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).QNRTPlayer = {}));
})(this, function (e) {
  'use strict';
  /*! *****************************************************************************
  ...
  function s(e) {
    return i(this, void 0, void 0, function () {
      ...
      return o(this, function (n) {
        switch (n.label) {
          case 0:
            return (t = { offerToReceiveAudio: !0, offerToReceiveVideo: !0 }), [4, e.createOffer(t)];
          case 1:
            return (r = n.sent()).sdp ? [2, -1 !== r.sdp.toLowerCase().indexOf('h264')] : [2, !1];
        }
      });
    });
  }
  function a() {
    return i(this, void 0, void 0, function () {
      ...
      return o(this, function (o) {
        switch (o.label) {
          case 0:
            return (e = !!window.RTCPeerConnection) ? [4, s((t = new RTCPeerConnection()))] : [2, { peerConnection: !1, H264: !1, getStats: !1 }];
          case 1:
            return (r = o.sent()), (n = !!t.getStats), t.close(), [4, s((i = new RTCPeerConnection()))];
          case 2:
            return (a = o.sent()), i.close(), [2, { peerConnection: e, H264: r || a, getStats: n }];
        }
      });
    });
  }
  ...
  var p = new (d(function (e, t) {
      !(function (r, n) {
        var i = 'function',
          ...
          g = {
            ...
            major: function (e) {
              return 'string' == typeof e ? e.replace(/[^\d\.]/g, '').split('.')[0] : n;
            },
            trim: function (e) {
                        ...
                        typeof (c = f[a]) === o && c.length > 0
                          ? 2 == c.length
                            ...
                            ? typeof c[1] !== i || (c[1].exec && c[1].test)
                              ? (this[c[0]] = p ? p.replace(c[1], c[2]) : n)
                              : (this[c[0]] = p ? c[1].call(this, p, c[2]) : n)
                            : 4 == c.length && (this[c[0]] = p ? c[3].call(this, p.replace(c[1], c[2])) : n)
                          : (this[c] = p || n);
                l += 2;
              }
            },
            str: function (e, t) {
              for (var r in t)
                if (typeof t[r] === o && t[r].length > 0) {
                  for (var i = 0; i < t[r].length; i++) if (g.has(t[r][i], e)) return '?' === r ? n : r;
          ...
          C = function (e, t) {
            if (('object' == typeof e && ((t = e), (e = n)), !(this instanceof C))) return new C(e, t).getResult();
            var i = e || (r && r.navigator && r.navigator.userAgent ? r.navigator.userAgent : ''),
              o = t ? g.extend(T, t) : T;
            return (
              (this.getBrowser = function () {
                var e = { name: n, version: n };
                return y.rgx.call(e, i, o.browser), (e.major = g.major(e.version)), e;
              }),
        ...
        (C.VERSION = '0.7.23'),
          (C.BROWSER = { NAME: a, MAJOR: 'major', VERSION: p }),
          (C.CPU = { ARCHITECTURE: l }),
          (C.DEVICE = { MODEL: s, VENDOR: d, TYPE: c, CONSOLE: u, MOBILE: f, SMARTTV: m, TABLET: h, WEARABLE: v, EMBEDDED: 'embedded' }),
          (C.ENGINE = { NAME: a, VERSION: p }),
          (C.OS = { NAME: a, VERSION: p }),
    ...
    l = { osName: p.os.name || '', osVersion: p.os.version || '', browserName: p.browser.name || '', browserVersion: p.browser.version || '' };
  function u(e, t, r) {
    return i(this, void 0, void 0, function () {
      var n, i, s, a, c, d;
      return o(this, function (o) {
        switch (o.label) {
          case 0:
            (n = { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(t) }),
              ...
              (o.label = 1);
          case 1:
            return o.trys.push([1, 3, , 4]), [4, fetch(e, n)];
          case 2:
            return (s = o.sent()), [3, 4];
          case 3:
            throw ((a = o.sent()), (d = void 0), (d = 'AbortError' === a.name ? 'pullStreamRequest, error: ' + b / 1e3 + 's timeout' : 'pullStreamRequest, error: ' + a.message), I(d, r), new T(d, r));
          case 4:
            if (200 !== s.status) throw ((d = 'pullStreamRequest, statusCode error: statusCode: ' + s.status + ', statusText: ' + s.statusText), I(d, r), new T(d, r));
            o.label = 5;
          case 5:
            return o.trys.push([5, 7, , 8]), [4, s.json()];
          case 6:
            return (c = o.sent()), [3, 8];
          case 7:
            throw (o.sent(), (d = 'parse response as json error: ' + s.text()), M(d, r), new T(d, r));
          case 8:
            if ([400, 500].includes(c.code)) throw (M(c.msg, r), new T(c.msg, r));
            if (403 === c.code) throw (D(c.msg, r), new T(c.msg, r));
            if (404 === c.code) throw (O(c.msg, r), new T(c.msg, r));
            if (![0, 200].includes(c.code)) throw new T('unexpected code: ' + c.code + ', msg: ' + c.msg, r);
            return [2, c];
        }
      });
    });
  ...
  function f() {
    ...
    return '[' + t(e.getHours()) + ':' + t(e.getMinutes()) + ':' + t(e.getSeconds()) + '.' + e.getMilliseconds() + ']';
  }
  var h = new ((function () {
    function e(e) {
      this.level = e;
    ...
    return (
      ...
      (e.prototype.log = function (e, t) {
        if ('log' === this.level) {
          var r = f(),
            n = r + ' %cLOG-QNRTPLAYER';
          console.info(n, 'color: #66ccff; font-weight: bold;', e);
          var i = { time: r, level: 'log', msg: e, id: v(8) };
          x(i, t);
        }
      }),
      (e.prototype.debug = function (e, t) {
        if ('log' === this.level || 'debug' === this.level) {
          var r = f(),
            n = r + ' %cDEBUG-QNRTPLAYER';
          console.info(n, 'color: #A28148; font-weight: bold;', e);
          var i = { time: r, level: 'debug', msg: e, id: v(8) };
          x(i, t);
        }
      }),
      (e.prototype.warning = function (e, t) {
        if ('disable' !== this.level) {
          var r = f(),
            n = r + ' %cWARNING-QNRTPLAYER';
          console.warn(n, 'color: #E44F44; font-weight: bold;', e);
          var i = { time: r, level: 'warning', msg: e, id: v(8) };
          x(i, t);
        }
      }),
      e
  ...
  function g(e, t, r) {
    void 0 === r && (r = !1);
    try {
      return r ? JSON.stringify(e, null, 2) : JSON.stringify(e);
    } catch (e) {
      return h.warning('json stringify error: ' + g(e, t), t), 'stringify error';
    }
  }
  function y(e, t) {
    var r = Math.pow(10, t);
  ...
  var w,
    T = (function (e) {
      function t(t, r) {
        ...
        return (n.msg = t), h.warning('SDK Error: ' + t, r), n;
      }
      return r(t, e), t;
    })(Error),
    C = { className: 'qn-rtplayer-media', width: '100%', height: '100%', objectFit: 'contain', volumn: 0.6, controls: !1, playsinline: !0, audioOnly: !1, muted: !1 },
    S = { audioBitrate: 0, videoBitrate: 0, frameWidth: 0, frameHeight: 0, frameRate: 0 };
  !(function (e) {
    (e[(e.STATE_IDLE = 0)] = 'STATE_IDLE'),
      (e[(e.STATE_INIT = 1)] = 'STATE_INIT'),
      (e[(e.STATE_READY = 2)] = 'STATE_READY'),
      (e[(e.STATE_PLAYING = 3)] = 'STATE_PLAYING'),
      (e[(e.STATE_STOP = 4)] = 'STATE_STOP'),
      (e[(e.STATE_ERROR = 5)] = 'STATE_ERROR');
  })(w || (w = {}));
  var b = 8e3,
    E = '1.0.8',
    R = d(function (e) {
        ...
        (n.getListeners = function (e) {
          ...
          (n.addListener = function (e, t) {
            ...
            var r,
              ...
              i = 'object' == typeof t;
            for (r in n) n.hasOwnProperty(r) && -1 === o(n[r], t) && n[r].push(i ? t : { listener: t, once: !1 });
            return this;
          }),
          (n.on = s('addListener')),
          ...
          (n.removeListener = function (e, t) {
            ...
            for (n in i) i.hasOwnProperty(n) && -1 !== (r = o(i[n], t)) && i[n].splice(r, 1);
            return this;
          }),
          ...
          (n.emitEvent = function (e, t) {
            ...
            for (o in s)
              if (s.hasOwnProperty(o))
                for (r = s[o].slice(0), i = 0; i < r.length; i++)
                  !0 === (n = r[i]).once && this.removeListener(e, n.listener), n.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, n.listener);
            return this;
          }),
  ...
  var P = {},
    ...
    I = function (e, t) {
      _('error', { code: 20001, errorType: 'networkError', msg: e }, t);
    },
    D = function (e, t) {
      _('error', { code: 20002, errorType: 'authFailed', msg: e }, t);
    },
    O = function (e, t) {
      _('error', { code: 20003, errorType: 'playStreamNotExist', msg: e }, t);
    },
    M = function (e, t) {
      _('error', { code: 20004, errorType: 'playRequestFailed', msg: e }, t);
    },
    L = function (e, t) {
      _('error', { code: 20005, errorType: 'descriptionError', msg: e }, t);
    },
    A = function (e, t) {
      _('error', { code: 20006, errorType: 'connectFailed', msg: e }, t);
    },
    j = function (e, t) {
      _('error', { code: 30001, errorType: 'rtcNotSupport', msg: e }, t);
    };
  let N = !0,
    z = !0;
  function G(e, t, r) {
  ...
  function V(e) {
    return 'boolean' != typeof e ? new Error('Argument type: ' + typeof e + '. Please use a boolean.') : ((z = !e), 'adapter.js deprecation warnings ' + (e ? 'disabled' : 'enabled'));
  }
  function B() {
  ...
  function J(e, t) {
    z && console.warn(e + ' is deprecated, please use ' + t + ' instead.');
  }
  function q(e) {
    const t = { browser: null, version: null };
    if (void 0 === e || !e.navigator) return (t.browser = 'Not a browser.'), t;
    const { navigator: r } = e;
    if (r.mozGetUserMedia) (t.browser = 'firefox'), (t.version = G(r.userAgent, /Firefox\/(\d+)\./, 1));
    else if (r.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer)) (t.browser = 'chrome'), (t.version = G(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
    else if (r.mediaDevices && r.userAgent.match(/Edge\/(\d+).(\d+)$/)) (t.browser = 'edge'), (t.version = G(r.userAgent, /Edge\/(\d+).(\d+)$/, 2));
    else {
      if (!e.RTCPeerConnection || !r.userAgent.match(/AppleWebKit\/(\d+)\./)) return (t.browser = 'Not a supported browser.'), t;
      (t.browser = 'safari'), (t.version = G(r.userAgent, /AppleWebKit\/(\d+)\./, 1)), (t.supportsUnifiedPlan = e.RTCRtpTransceiver && 'currentDirection' in e.RTCRtpTransceiver.prototype);
    }
    return t;
  }
  function W(e) {
  ...
  function K(e, t, r) {
    ...
    return (
      ...
      o.forEach((t) => {
        e.forEach((r) => {
          r.type === n && r.trackId === t.id && Y(e, r, i);
        });
      }),
      i
    );
      ...
      i = function (e, i) {
        ...
        if (e && 'object' == typeof e.video) {
          ...
          if (
            ...
            let r;
            if ((delete e.video.facingMode, 'environment' === o.exact || 'environment' === o.ideal ? (r = ['back', 'rear']) : ('user' !== o.exact && 'user' !== o.ideal) || (r = ['front']), r))
              return t.mediaDevices.enumerateDevices().then((t) => {
                ...
                return (
                  !s && t.length && r.includes('back') && (s = t[t.length - 1]),
                  s && (e.video.deviceId = o.exact ? { exact: s.deviceId } : { ideal: s.deviceId }),
                  (e.video = n(e.video)),
                  Q('chrome: ' + JSON.stringify(e)),
                  i(e)
                );
              });
          }
        ...
        return Q('chrome: ' + JSON.stringify(e)), i(e);
      },
      o = function (e) {
        return r.version >= 64
          ? e
  ...
  function Z(e) {
    ...
    } else F(e, 'track', (e) => (e.transceiver || Object.defineProperty(e, 'transceiver', { value: { receiver: e.receiver } }), e));
  }
  function ee(e) {
  ...
  function te(e) {
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      ...
      const i = function (e) {
          ...
          return (
            e.result().forEach((e) => {
              const r = { id: e.id, timestamp: e.timestamp, type: { localcandidate: 'local-candidate', remotecandidate: 'remote-candidate' }[e.type] || e.type };
              e.names().forEach((t) => {
                r[t] = e.stat(t);
              }),
                (t[r.id] = r);
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
        ...
        return (
          ...
          this.getReceivers().forEach((t) => (t.track === e && (r ? (n = !0) : (r = t)), t.track === e)),
          n || (t && r)
  ...
  function ie(e) {
    if (!e.RTCPeerConnection) return;
    const t = q(e);
    if (e.RTCPeerConnection.prototype.addTrack && t.version >= 65) return ne(e);
  ...
  var ae = Object.freeze({
    ...
    shimMediaStream: X,
    shimOnTrack: Z,
    shimGetSendersWithDtmf: ee,
    shimGetStats: te,
    shimSenderReceiverGetStats: re,
    shimAddTrackRemoveTrackWithNative: ne,
    shimAddTrackRemoveTrack: ie,
    shimPeerConnection: oe,
    fixNegotiationNeeded: se,
    shimGetUserMedia: $,
  ...
  var ce = d(function (e) {
    ...
    (t.localCName = t.generateIdentifier()),
      ...
      (t.parseRtpParameters = function (e) {
        for (var r = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, n = t.splitLines(e)[0].split(' '), i = 3; i < n.length; i++) {
          var o = n[i],
      ...
      (t.parseRtpEncodingParameters = function (e) {
        ...
        d.length > 0 && d[0].length > 1 && d[0][0] === c && (r = d[0][1]),
          i.codecs.forEach(function (e) {
            if ('RTX' === e.name.toUpperCase() && e.parameters.apt) {
              var t = { ssrc: c, codecPayloadType: parseInt(e.parameters.apt, 10) };
              c && r && (t.rtx = { ssrc: r }), n.push(t), o && (((t = JSON.parse(JSON.stringify(t))).fec = { ssrc: c, mechanism: s ? 'red+ulpfec' : 'red' }), n.push(t));
            }
          }),
        ...
        return (
          p.length &&
            ((p = 0 === p[0].indexOf('b=TIAS:') ? parseInt(p[0].substr(7), 10) : 0 === p[0].indexOf('b=AS:') ? 1e3 * parseInt(p[0].substr(5), 10) * 0.95 - 16e3 : void 0),
      ...
      (t.parseSctpDescription = function (e) {
        ...
        if (o.length > 0) return { port: parseInt(o[0].substr(12), 10), protocol: n.fmt, maxMessageSize: r };
        if (t.matchPrefix(e, 'a=sctpmap:').length > 0) {
          var s = t.matchPrefix(e, 'a=sctpmap:')[0].substr(10).split(' ');
          return { port: parseInt(s[0], 10), protocol: s[1], maxMessageSize: r };
        }
      }),
      ...
      (t.writeMediaSection = function (e, r, n, i) {
        ...
        if (
          ...
          (o += t.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), 'offer' === n ? 'actpass' : 'active')),
          (o += 'a=mid:' + e.mid + '\r\n'),
          e.direction
            ? (o += 'a=' + e.direction + '\r\n')
      ...
      (t.isValidSDP = function (e) {
        ...
        for (var r = t.splitLines(e), n = 0; n < r.length; n++) if (r[n].length < 2 || '=' !== r[n].charAt(1)) return !1;
        return !0;
      }),
      (e.exports = t);
  });
  function de(e, t, r, n, i) {
    var o = ce.writeRtpDescription(e.kind, t);
    if (
      ((o += ce.writeIceParameters(e.iceGatherer.getLocalParameters())),
      (o += ce.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), 'offer' === r ? 'actpass' : i || 'active')),
      (o += 'a=mid:' + e.mid + '\r\n'),
      ...
      (o += 'a=' + a),
        ...
        e.sendEncodingParameters[0].rtx &&
          ((o += 'a=ssrc:' + e.sendEncodingParameters[0].rtx.ssrc + ' ' + a), (o += 'a=ssrc-group:FID ' + e.sendEncodingParameters[0].ssrc + ' ' + e.sendEncodingParameters[0].rtx.ssrc + '\r\n'));
    }
    return (
      (o += 'a=ssrc:' + e.sendEncodingParameters[0].ssrc + ' cname:' + ce.localCName + '\r\n'),
  ...
  var he = function (e, t) {
    ...
    var i = function (r) {
      ...
      if (
        ...
        throw fe('NotSupportedError', "rtcpMuxPolicy 'negotiate' is not supported");
      ...
      (this._config = r), (this.transceivers = []), (this._sdpSessionId = ce.generateSessionId()), (this._sdpSessionVersion = 0), (this._dtlsRole = void 0), (this._isClosed = !1);
    };
    Object.defineProperty(i.prototype, 'localDescription', {
      ...
      (i.prototype.addTrack = function (t, r) {
        if (this._isClosed) throw fe('InvalidStateError', 'Attempted to call addTrack on a closed peerconnection.');
        var n;
        if (
          ...
          throw fe('InvalidAccessError', 'Track already exists.');
      ...
      (i.prototype.removeTrack = function (t) {
        if (this._isClosed) throw fe('InvalidStateError', 'Attempted to call removeTrack on a closed peerconnection.');
        ...
        if (!r) throw fe('InvalidAccessError', 'Sender was not created by this connection.');
        var n = r.stream;
        r.rtpSender.stop(),
          (r.rtpSender = null),
          (r.track = null),
          ...
          (this.transceivers[r].bufferedCandidateEvents = null),
            ...
            (i.onlocalcandidate = function (e) {
              if (!(n.usingBundle && r > 0)) {
                ...
                if (a) ('new' !== i.state && 'gathering' !== i.state) || (i.state = 'completed');
                else {
                  'new' === i.state && (i.state = 'gathering'), (s.component = 1), (s.ufrag = i.getLocalParameters().usernameFragment);
                  var c = ce.writeCandidate(s);
                  (o.candidate = Object.assign(o.candidate, ce.parseCandidate(c))),
                ...
                var d = ce.getMediaSections(n._localDescription.sdp);
                (d[o.candidate.sdpMLineIndex] += a ? 'a=end-of-candidates\r\n' : 'a=' + o.candidate.candidate + '\r\n'),
                  (n._localDescription.sdp = ce.getDescription(n._localDescription.sdp) + d.join(''));
                ...
                'gathering' !== n.iceGatheringState && ((n.iceGatheringState = 'gathering'), n._emitGatheringStateChange()),
                  a || n._dispatchEvent('icecandidate', o),
                  p && (n._dispatchEvent('icecandidate', new Event('icecandidate')), (n.iceGatheringState = 'complete'), n._emitGatheringStateChange());
              }
            }),
            e.setTimeout(function () {
      ...
      (i.prototype._transceive = function (e, r, n) {
        var i = pe(e.localCapabilities, e.remoteCapabilities);
        r &&
          e.rtpSender &&
          ((i.encodings = e.sendEncodingParameters),
          (i.rtcp = { cname: ce.localCName, compound: e.rtcpParameters.compound }),
      ...
      (i.prototype.setLocalDescription = function (e) {
        var t,
          r,
          n = this;
        if (-1 === ['offer', 'answer'].indexOf(e.type)) return Promise.reject(fe('TypeError', 'Unsupported type "' + e.type + '"'));
        if (!le('setLocalDescription', e.type, n.signalingState) || n._isClosed) return Promise.reject(fe('InvalidStateError', 'Can not set local ' + e.type + ' in state ' + n.signalingState));
        if ('offer' === e.type)
          (t = ce.splitSections(e.sdp)),
            (r = t.shift()),
            t.forEach(function (e, t) {
              var r = ce.parseRtpParameters(e);
          ...
          (t = ce.splitSections(n._remoteDescription.sdp)), (r = t.shift());
          var i = ce.matchPrefix(r, 'a=ice-lite').length > 0;
          t.forEach(function (e, t) {
            ...
            if (!(ce.isRejected(e) && 0 === ce.matchPrefix(e, 'a=bundle-only').length) && !o.rejected) {
              var l = ce.getIceParameters(e, r),
                u = ce.getDtlsParameters(e, r);
              i && (u.role = 'server'), (n.usingBundle && 0 !== t) || (n._gather(o.mid, t), 'new' === a.state && a.start(s, l, i ? 'controlling' : 'controlled'), 'new' === c.state && c.start(u));
              var f = pe(d, p);
      ...
      (i.prototype.setRemoteDescription = function (i) {
        var o = this;
        if (-1 === ['offer', 'answer'].indexOf(i.type)) return Promise.reject(fe('TypeError', 'Unsupported type "' + i.type + '"'));
        if (!le('setRemoteDescription', i.type, o.signalingState) || o._isClosed) return Promise.reject(fe('InvalidStateError', 'Can not set remote ' + i.type + ' in state ' + o.signalingState));
        var s = {};
        o.remoteStreams.forEach(function (e) {
          s[e.id] = e;
        });
        var a = [],
          c = ce.splitSections(i.sdp),
          d = c.shift(),
          p = ce.matchPrefix(d, 'a=ice-lite').length > 0,
          l = ce.matchPrefix(d, 'a=group:BUNDLE ').length > 0;
        o.usingBundle = l;
        var u = ce.matchPrefix(d, 'a=ice-options:')[0];
        return (
          (o.canTrickleIceCandidates = !!u && u.substr(14).split(' ').indexOf('trickle') >= 0),
          c.forEach(function (n, c) {
            var u = ce.splitLines(n),
              f = ce.getKind(n),
              h = ce.isRejected(n) && 0 === ce.matchPrefix(n, 'a=bundle-only').length,
              m = u[0].substr(2).split(' ')[2],
              v = ce.getDirection(n, d),
              g = ce.parseMsid(n),
              y = ce.getMid(n) || ce.generateIdentifier();
            if (h || ('application' === f && ('DTLS/SCTP' === m || 'UDP/DTLS/SCTP' === m))) o.transceivers[c] = { mid: y, kind: f, protocol: m, rejected: !0 };
            else {
              var w, T, C, S, b, E, R, P, k;
              !h && o.transceivers[c] && o.transceivers[c].rejected && (o.transceivers[c] = o._createTransceiver(f, !0));
              var _,
                x,
                I = ce.parseRtpParameters(n);
              h || ((_ = ce.getIceParameters(n, d)), ((x = ce.getDtlsParameters(n, d)).role = 'client')), (R = ce.parseRtpEncodingParameters(n));
              var D = ce.parseRtcpParameters(n),
                O = ce.matchPrefix(n, 'a=end-of-candidates', d).length > 0,
                M = ce
                  .matchPrefix(n, 'a=candidate:')
                  .map(function (e) {
                    return ce.parseCandidate(e);
                  })
                  .filter(function (e) {
              ...
              if (
                ...
                if ('answer' === i.type && !h) {
                  (T = (w = o.transceivers[c]).iceGatherer),
                    (C = w.iceTransport),
                    (S = w.dtlsTransport),
                    (b = w.rtpReceiver),
                    (E = w.sendEncodingParameters),
                    (P = w.localCapabilities),
                    (o.transceivers[c].recvEncodingParameters = R),
                    (o.transceivers[c].remoteCapabilities = I),
                    (o.transceivers[c].rtcpParameters = D),
                    M.length &&
                      'new' === C.state &&
                      ((!p && !O) || (l && 0 !== c)
                        ...
                        : C.setRemoteCandidates(M)),
                    (l && 0 !== c) || ('new' === C.state && C.start(T, _, 'controlling'), 'new' === S.state && S.start(x)),
                    !pe(w.localCapabilities, w.remoteCapabilities).codecs.filter(function (e) {
                      return 'rtx' === e.name.toLowerCase();
                    }).length &&
                      w.sendEncodingParameters[0].rtx &&
                      delete w.sendEncodingParameters[0].rtx,
                    o._transceive(w, 'sendrecv' === v || 'recvonly' === v, 'sendrecv' === v || 'sendonly' === v),
                    !b || ('sendrecv' !== v && 'sendonly' !== v)
                      ? delete w.rtpReceiver
                      : ((k = b.track),
                        g
                          ? (s[g.stream] || (s[g.stream] = new e.MediaStream()), r(k, s[g.stream]), a.push([k, b, s[g.stream]]))
                          : (s.default || (s.default = new e.MediaStream()), r(k, s.default), a.push([k, b, s.default])));
                }
              } else {
                ((w = o.transceivers[c] || o._createTransceiver(f)).mid = y),
                  w.iceGatherer || (w.iceGatherer = o._createIceGatherer(c, l)),
                  M.length &&
                    ...
                    (!O || (l && 0 !== c)
                      ...
                      : w.iceTransport.setRemoteCandidates(M)),
                  (P = e.RTCRtpReceiver.getCapabilities(f)),
                  t < 15019 &&
                    (P.codecs = P.codecs.filter(function (e) {
                      return 'rtx' !== e.name;
                    })),
                  (E = w.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]);
                var L,
                  A = !1;
                if ('sendrecv' === v || 'sendonly' === v) {
                  if (((A = !w.rtpReceiver), (b = w.rtpReceiver || new e.RTCRtpReceiver(w.dtlsTransport, f)), A))
                    (k = b.track),
                      (g && '-' === g.stream) ||
                        (g
                          ? (s[g.stream] ||
                              ((s[g.stream] = new e.MediaStream()),
                              Object.defineProperty(s[g.stream], 'id', {
                                get: function () {
                                  return g.stream;
                                },
                              })),
                      ...
                      L && (r(k, L), w.associatedRemoteMediaStreams.push(L)),
                      a.push([k, b, L]);
                } else
                  w.rtpReceiver &&
                    w.rtpReceiver.track &&
                ...
                (w.localCapabilities = P),
                  (w.remoteCapabilities = I),
                  (w.rtpReceiver = b),
                  (w.rtcpParameters = D),
                  (w.sendEncodingParameters = E),
                  (w.recvEncodingParameters = R),
      ...
      (i.prototype.createOffer = function () {
        var r = this;
        if (r._isClosed) return Promise.reject(fe('InvalidStateError', 'Can not call createOffer after close'));
        ...
        var s = ce.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
        r.transceivers.forEach(function (n, i) {
          var o = n.track,
            s = n.kind,
            a = n.mid || ce.generateIdentifier();
          (n.mid = a), n.iceGatherer || (n.iceGatherer = r._createIceGatherer(i, r.usingBundle));
          ...
          o && t >= 15019 && 'video' === s && !d[0].rtx && (d[0].rtx = { ssrc: d[0].ssrc + 1 }),
          ...
          r.transceivers.forEach(function (e, t) {
            (s += de(e, e.localCapabilities, 'offer', e.stream, r._dtlsRole)),
              (s += 'a=rtcp-rsize\r\n'),
              !e.iceGatherer ||
                'new' === r.iceGatheringState ||
                (0 !== t && r.usingBundle) ||
                (e.iceGatherer.getLocalCandidates().forEach(function (e) {
                  (e.component = 1), (s += 'a=' + ce.writeCandidate(e) + '\r\n');
                }),
                'completed' === e.iceGatherer.state && (s += 'a=end-of-candidates\r\n'));
          });
        var a = new e.RTCSessionDescription({ type: 'offer', sdp: s });
        return Promise.resolve(a);
      }),
      (i.prototype.createAnswer = function () {
        var r = this;
        if (r._isClosed) return Promise.reject(fe('InvalidStateError', 'Can not call createAnswer after close'));
        if ('have-remote-offer' !== r.signalingState && 'have-local-pranswer' !== r.signalingState)
          return Promise.reject(fe('InvalidStateError', 'Can not call createAnswer in signalingState ' + r.signalingState));
        var n = ce.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
        r.usingBundle &&
          (n +=
            'a=group:BUNDLE ' +
            r.transceivers
        ...
        var i = ce.getMediaSections(r._remoteDescription.sdp).length;
          ...
          if (!(o + 1 > i)) {
            ...
            if (e.stream)
              'audio' === e.kind ? (s = e.stream.getAudioTracks()[0]) : 'video' === e.kind && (s = e.stream.getVideoTracks()[0]),
                s && t >= 15019 && 'video' === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = { ssrc: e.sendEncodingParameters[0].ssrc + 1 });
            var a = pe(e.localCapabilities, e.remoteCapabilities);
            !a.codecs.filter(function (e) {
              return 'rtx' === e.name.toLowerCase();
            }).length &&
              e.sendEncodingParameters[0].rtx &&
              delete e.sendEncodingParameters[0].rtx,
              (n += de(e, a, 'answer', e.stream, r._dtlsRole)),
      ...
      (i.prototype.addIceCandidate = function (e) {
        ...
        return e && void 0 === e.sdpMLineIndex && !e.sdpMid
          ...
          : new Promise(function (n, i) {
              if (!r._remoteDescription) return i(fe('InvalidStateError', 'Can not add ICE candidate without a remote description'));
              if (e && '' !== e.candidate) {
                ...
                if (!a) return i(fe('OperationError', 'Can not add ICE candidate'));
                if (a.rejected) return n();
                var c = Object.keys(e.candidate).length > 0 ? ce.parseCandidate(e.candidate) : {};
                if ('tcp' === c.protocol && (0 === c.port || 9 === c.port)) return n();
                if (c.component && 1 !== c.component) return n();
                if ((0 === o || (o > 0 && a.iceTransport !== r.transceivers[0].iceTransport)) && !ue(a.iceTransport, c)) return i(fe('OperationError', 'Can not add ICE candidate'));
                var d = e.candidate.trim();
                0 === d.indexOf('a=') && (d = d.substr(2)),
                  ((t = ce.getMediaSections(r._remoteDescription.sdp))[o] += 'a=' + (c.type ? d : 'end-of-candidates') + '\r\n'),
                  (r._remoteDescription.sdp = ce.getDescription(r._remoteDescription.sdp) + t.join(''));
              } else for (var p = 0; p < r.transceivers.length && (r.transceivers[p].rejected || (r.transceivers[p].iceTransport.addRemoteCandidate({}), ((t = ce.getMediaSections(r._remoteDescription.sdp))[p] += 'a=end-of-candidates\r\n'), (r._remoteDescription.sdp = ce.getDescription(r._remoteDescription.sdp) + t.join('')), !r.usingBundle)); p++);
              n();
            });
      }),
      (i.prototype.getStats = function (t) {
        if (t && t instanceof e.MediaStreamTrack) {
          ...
          if (
            ...
            throw fe('InvalidAccessError', 'Invalid selector.');
          return r.getStats();
        }
        var n = [];
        return (
        ...
        e &&
          ...
          ((e.iceServers = (function (e, t) {
            ...
            return (e = JSON.parse(JSON.stringify(e))).filter((e) => {
              if (e && (e.urls || e.url)) {
                let t = e.urls || e.url;
                e.url && !e.urls && J('RTCIceServer.url', 'RTCIceServer.urls');
          ...
          B('ICE servers after filtering:', e.iceServers)),
        new r(e)
      );
    }),
  ...
  var we = Object.freeze({ __proto__: null, shimPeerConnection: ge, shimReplaceTrack: ye, shimGetUserMedia: me, shimGetDisplayMedia: ve });
  function Te(e) {
    const t = q(e),
      r = e && e.navigator,
    ...
    if (
      ((r.getUserMedia = function (e, t, n) {
        J('navigator.getUserMedia', 'navigator.mediaDevices.getUserMedia'), r.mediaDevices.getUserMedia(e).then(t, n);
      }),
        ...
        ((r.mediaDevices.getUserMedia = function (r) {
          return (
            'object' == typeof r &&
              ...
              ((r = JSON.parse(JSON.stringify(r))), e(r.audio, 'autoGainControl', 'mozAutoGainControl'), e(r.audio, 'noiseSuppression', 'mozNoiseSuppression')),
            t(r)
          );
        }),
      ...
      if (n && n.prototype.applyConstraints) {
        ...
        n.prototype.applyConstraints = function (r) {
          return (
            'audio' === this.kind && 'object' == typeof r && ((r = JSON.parse(JSON.stringify(r))), e(r, 'autoGainControl', 'mozAutoGainControl'), e(r, 'noiseSuppression', 'mozNoiseSuppression')),
            t.apply(this, [r])
          );
        };
      }
  ...
  function Se(e) {
    ...
    const r = { inboundrtp: 'inbound-rtp', outboundrtp: 'outbound-rtp', candidatepair: 'candidate-pair', localcandidate: 'local-candidate', remotecandidate: 'remote-candidate' },
  ...
  var De = Object.freeze({
    ...
    shimSenderGetStats: be,
    shimReceiverGetStats: Ee,
    shimRemoveStream: Re,
    shimRTCDataChannel: Pe,
    shimAddTransceiver: ke,
    shimGetParameters: _e,
    shimCreateOffer: xe,
    shimCreateAnswer: Ie,
    shimGetUserMedia: Te,
    shimGetDisplayMedia: function (e, t) {
  ...
  function Ae(e) {
    ...
    if (t.mediaDevices && t.mediaDevices.getUserMedia) {
      ...
      t.mediaDevices.getUserMedia = (e) => r(je(e));
    }
    !t.getUserMedia &&
      t.mediaDevices &&
      t.mediaDevices.getUserMedia &&
  ...
  function je(e) {
    return e && void 0 !== e.video ? Object.assign({}, e, { video: H(e.video) }) : e;
  }
  function Ne(e) {
    if (!e.RTCPeerConnection) return;
      ...
      if (e && e.iceServers) {
        ...
        for (let r = 0; r < e.iceServers.length; r++) {
          ...
          !n.hasOwnProperty('urls') && n.hasOwnProperty('url')
            ? (J('RTCIceServer.url', 'RTCIceServer.urls'), (n = JSON.parse(JSON.stringify(n))), (n.urls = n.url), delete n.url, t.push(n))
  ...
  var Ue = Object.freeze({
    __proto__: null,
    shimLocalStreamsAPI: Oe,
    shimRemoteStreamsAPI: Me,
    shimCallbacksAPI: Le,
    shimGetUserMedia: Ae,
    shimConstraints: je,
  ...
  function Ve(e) {
    ...
    (e.RTCIceCandidate = function (e) {
      ...
      F(e, 'icecandidate', (t) => (t.candidate && Object.defineProperty(t, 'candidate', { value: new e.RTCIceCandidate(t.candidate), writable: 'false' }), t));
  }
  function Be(e) {
    if (!e.RTCPeerConnection) return;
    const t = q(e);
    ...
    const r = function (e) {
        if (!e || !e.sdp) return !1;
        const t = ce.splitSections(e.sdp);
        return (
          t.shift(),
          t.some((e) => {
            const t = ce.parseMLine(e);
      ...
      o = function (e, r) {
        ...
        const i = ce.matchPrefix(e.sdp, 'a=max-message-size:');
    ...
    e.RTCPeerConnection.prototype.setRemoteDescription = function () {
      ...
      if (r(arguments[0])) {
        const e = n(arguments[0]),
          ...
          r = o(arguments[0], e);
        let s;
        s = 0 === t && 0 === r ? Number.POSITIVE_INFINITY : 0 === t || 0 === r ? Math.max(t, r) : Math.min(t, r);
        const a = {};
        Object.defineProperty(a, 'maxMessageSize', { get: () => s }), (this._sctp = a);
      }
  ...
  var He = Object.freeze({ __proto__: null, shimRTCIceCandidate: Ve, shimMaxMessageSize: Be, shimSendThrowTypeError: Je, shimConnectionState: qe, removeAllowExtmapMixed: We });
  const Ye = (function ({ window: e } = {}, t = { shimChrome: !0, shimFirefox: !0, shimEdge: !0, shimSafari: !0 }) {
    const r = B,
      n = q(e),
      i = { browserDetails: n, commonShim: He, extractVersion: G, disableLog: U, disableWarnings: V };
    switch (n.browser) {
      case 'chrome':
        if (!ae || !oe || !t.shimChrome) return r('Chrome shim is not included in this adapter release.'), i;
        if (null === n.version) return r('Chrome shim can not determine version, not shimming.'), i;
        r('adapter.js shimming chrome.'), (i.browserShim = ae), $(e), X(e), oe(e), Z(e), ie(e), ee(e), te(e), re(e), se(e), Ve(e), qe(e), Be(e), Je(e), We(e);
        break;
      case 'firefox':
        if (!De || !Se || !t.shimFirefox) return r('Firefox shim is not included in this adapter release.'), i;
        r('adapter.js shimming firefox.'), (i.browserShim = De), Te(e), Se(e), Ce(e), Re(e), be(e), Ee(e), Pe(e), ke(e), _e(e), xe(e), Ie(e), Ve(e), qe(e), Be(e), Je(e);
        break;
      case 'edge':
        if (!we || !ge || !t.shimEdge) return r('MS edge shim is not included in this adapter release.'), i;
        r('adapter.js shimming edge.'), (i.browserShim = we), me(e), ve(e), ge(e), ye(e), Be(e), Je(e);
        break;
      case 'safari':
        if (!Ue || !t.shimSafari) return r('Safari shim is not included in this adapter release.'), i;
        r('adapter.js shimming safari.'), (i.browserShim = Ue), Ne(e), Ge(e), Le(e), Oe(e), Me(e), ze(e), Ae(e), Fe(e), Ve(e), Be(e), Je(e), We(e);
        break;
      default:
  ...
  Ye.browserDetails.browser, Ye.browserDetails.version, Ye.browserDetails.supportsUnifiedPlan;
  var Ke = 0,
    Qe = (function () {
      function e(e) {
        (this.statsIntervalTime = 1e3), (this.statsReportSleepTime = 2e3), (this.playerEmitterId = ''), (this.playerEmitterId = e || '');
      }
      return (
        (e.prototype.initPc = function () {
          this.release();
          var e = new RTCPeerConnection();
          Ke++;
          var t = this.playerEmitterId;
          (e.onnegotiationneeded = function () {
            h.log('pc.onnegotiationneeded', t);
          }),
            (e.onicecandidate = function (e) {
              h.log('pc.onicecandidate: ' + g(e.candidate, t), t);
            }),
            (e.oniceconnectionstatechange = function () {
              h.log('pc.oniceconnectionstatechange: ' + e.iceConnectionState, t);
            }),
            (e.onicegatheringstatechange = function () {
              h.log('pc.onicegatheringstatechange : ' + e.iceGatheringState, t);
            }),
            (e.onsignalingstatechange = function () {
              h.log('pc.onsignalingstatechange: ' + e.signalingState, t);
            }),
            (this.pc = e);
        }),
        (e.prototype.pullStream = function (e, t) {
          var r = this;
          this.initPc();
          var s = this.playerEmitterId;
                ...
                switch (o.label) {
                  case 0:
                    return (
                      o.trys.push([0, 5, , 6]),
                      (r = new MediaStream()),
                      l.browserName.toLocaleLowerCase().indexOf('firefox') > -1
                        ? (this.pc.oniceconnectionstatechange = function () {
                            switch ((h.log('pc.onconnectionstatechange: ' + w.pc.iceConnectionState, s), w.pc.iceConnectionState)) {
                              case 'connected':
                                w.initStats(), a(r);
                                break;
                              case 'disconnected':
                                A('pc connection disconnected', s);
                                break;
                              case 'failed':
                              case 'closed':
                                c(new T('peerconnection connect error: ' + w.pc.connectionState, s));
                            }
                          })
                        : (this.pc.onconnectionstatechange = function () {
                            switch ((h.log('pc.onconnectionstatechange: ' + w.pc.connectionState, s), w.pc.connectionState)) {
                              case 'connected':
                                w.initStats(), a(r);
                                break;
                              case 'disconnected':
                      ...
                      (this.pc.ontrack = function (e) {
                        if (('video' === e.track.kind && !1 === t) || 'audio' === e.track.kind) {
                          switch (e.track.kind) {
                            case 'video':
                              w.videoTrack = e.track;
                              break;
                            case 'audio':
                              w.audioTrack = e.track;
                          }
                          r.addTrack(e.track), h.log('peerConnection.ontrack, kind: ' + e.track.kind + " + ', id: " + e.track.id, s);
                        }
                      }),
                      (i = g(n(n({}, l), { SDK_VERSION: E }), s)),
                      [4, this.createOffer()]
                    );
                  case 1:
                    return (d = o.sent()), h.log('local offer: \n' + d.sdp, s), (d = this.mungSDP(d)), [4, this.setLocal(d)];
                  case 2:
                    if ((o.sent(), !(p = /[a-zA-Z0-9]{3,7}:\/\/([^/]+)\//.exec(e)))) throw new T('streamurl is not valid: ' + e, s);
                    return 'https:' !== (f = location.protocol) && 'http:' !== f && (f = 'http:'), [4, u(f + '//' + p[1] + '/rtc/v1/play', { streamurl: e, clientip: i, sdp: d.sdp }, s)];
                  case 3:
                    return (
                      (m = o.sent()), h.log('remote answer, \n' + m.sdp, s), (this.sessionId = m.sessionid), (v = new RTCSessionDescription({ type: 'answer', sdp: m.sdp })), [4, this.setRemote(v)]
                    );
                  case 4:
                    return o.sent(), [3, 6];
                  case 5:
                    return (y = o.sent()), c(y instanceof Error ? new T(y.message, s) : new T(String(y), s)), [3, 6];
                  case 6:
                    return [2];
                }
              });
        ...
        (e.prototype.initStats = function () {
          var e = this;
          this.statsIntervalId && clearInterval(this.statsIntervalId);
          var t,
            r = 0;
            ...
            e.pc
              ...
              .then(function () {
                return new Promise(function (r) {
                  t = setTimeout(r, e.statsReportSleepTime);
                });
              })
              .then(function () {
              ...
              .then(function (s) {
                i = s;
                var a = e.processStats(n, i),
                  c = a.audioBitrate,
                  d = a.videoBitrate;
                0 === c && 0 === d
                  ? ++r >= 4 &&
                    (e.statsIntervalId && clearInterval(e.statsIntervalId),
                    t && clearTimeout(t),
                    (function (e, t) {
                      _('error', { code: 20007, errorType: 'playTimeout', msg: e }, t);
                    })('stream play failed, please check if stream is available', o),
                    (r = 0))
                  : (r = 0),
                  (function (e, t) {
                    _('stats', e, t);
              ...
              .catch(function (e) {
                h.debug('getStats error: ' + e.toString(), o);
              });
          }, this.statsIntervalTime);
        }),
        (e.prototype.release = function () {
          this.pc && this.pc.close(), this.recycleClosedPC(), this.statsIntervalId && clearInterval(this.statsIntervalId);
        }),
        (e.prototype.recycleClosedPC = function () {
          if (!(Ke < 100)) {
            Ke = 0;
            var e = document.createElement('img');
            (e.src = window.URL.createObjectURL(new Blob([new ArrayBuffer(1e8)]))),
              (e.onerror = function () {
                window.URL.revokeObjectURL(this.src), (e = null);
              });
          }
        }),
          ...
          return (
            t.forEach(function (t) {
              if ('inbound-rtp' === t.type && !0 !== t.isRemote) {
                if ('audio' === t.mediaType || t.id.toLocaleLowerCase().includes('audio')) {
                  if (!(i = e.get(t.id))) return;
                  n.audioBitrate = y((8 * (t.bytesReceived - i.bytesReceived)) / 1e3 / (r.statsReportSleepTime / 1e3), 2);
                }
                if ('video' === t.mediaType || t.id.toLocaleLowerCase().includes('video')) {
                  var i;
                  if (!(i = e.get(t.id))) return;
                  if (((n.videoBitrate = y((8 * (t.bytesReceived - i.bytesReceived)) / 1e3 / (r.statsReportSleepTime / 1e3), 2)), t.frameWidth))
                    (n.frameWidth = t.frameWidth), (n.frameHeight = t.frameHeight);
          ...
          return (
            ...
            i(this, void 0, void 0, function () {
              return o(this, function (r) {
                switch (r.label) {
                  case 0:
                    return [4, this.pc.createOffer({ offerToReceiveAudio: e, offerToReceiveVideo: t })];
                  case 1:
                    return [2, r.sent()];
                }
              });
        ...
        (e.prototype.setLocal = function (e) {
          return i(this, void 0, void 0, function () {
            ...
            return o(this, function (n) {
              switch (n.label) {
                case 0:
                  return n.trys.push([0, 2, , 3]), [4, this.pc.setLocalDescription(e)];
                case 1:
                  return n.sent(), [3, 3];
                case 2:
                  throw ((t = n.sent()), (r = 'set local sdp error: \n' + e.sdp + '\n' + g(t, this.playerEmitterId)), L(r, this.playerEmitterId), new T(r, this.playerEmitterId));
                case 3:
                  return [2];
              }
            });
          ...
          return i(this, void 0, void 0, function () {
            ...
            return o(this, function (i) {
              switch (i.label) {
                ...
                case 1:
                  return i.trys.push([1, 3, , 4]), [4, this.pc.setRemoteDescription(t)];
                case 2:
                  return i.sent(), [3, 4];
                case 3:
                  throw ((r = i.sent()), (n = 'set remote sdp error: \n' + t.sdp + '\n' + g(r, this.playerEmitterId)), L(n, this.playerEmitterId), new T(n, this.playerEmitterId));
                case 4:
                  return [2];
              }
            });
    ...
    $e = (function (e) {
      function t() {
        ...
        var r = (function () {
            var e = new R(),
              t = k();
            return (P[t] = e), { emitterId: t, emitter: e };
          })(),
          n = r.emitterId,
          i = r.emitter;
        return (
          ...
          i.on('stats', function (e) {
            t.emit('stats', e);
          }),
          i.on('error', function (e) {
            t.setState(w.STATE_ERROR), t._stop(), t.emit('error', e);
          }),
          i.on('playerStateChanged', function (e) {
            h.log('playerStateChanged: ' + e, n), t.emit('playerStateChanged', e);
          }),
          t.setState(w.STATE_IDLE),
          a().then(function (e) {
            (t.playerSupport = e), e.peerConnection || (h.warning('RTC not supported', n), j('RTC not supported!', n)), e.H264 || (h.warning('H264 not supported!', n), j('H264 not supported!', n));
          }),
          t
        );
      }
      return (
        ...
        (t.prototype.setState = function (e) {
          this.playerState !== e &&
            ((this.playerState = e),
            (function (e, t) {
              _('playerStateChanged', e, t);
            })(e, this.playerEmitterId));
        }),
        (t.prototype.init = function (e) {
          this.setState(w.STATE_INIT), (this.config = n(n({}, C), e));
        }),
        (t.prototype.getConfig = function () {
          if (!this.config) throw new T('config is not initilized, try init() first.', this.playerEmitterId);
          return this.config;
        }),
        (t.prototype.setConfig = function (e) {
          if (!this.config) throw new T('config is not initilized, try init() first.', this.playerEmitterId);
          if (!this.mediaElement) throw new T('media is not initialized, try play() first.', this.playerEmitterId);
          void 0 !== e.className && ((this.config.className = e.className), (this.mediaElement.className = this.config.className)),
            void 0 !== e.controls && ((this.config.controls = e.controls), (this.mediaElement.controls = this.config.controls)),
            void 0 !== e.width && ((this.config.width = e.width), (this.mediaElement.style.width = this.config.width)),
            void 0 !== e.height && ((this.config.height = e.height), (this.mediaElement.style.height = this.config.height)),
            void 0 !== e.objectFit && ((this.config.objectFit = e.objectFit), (this.mediaElement.style.objectFit = this.config.objectFit)),
            void 0 !== e.playsinline &&
              ((this.config.playsinline = e.playsinline), (this.mediaElement.playsInline = this.config.playsinline), this.mediaElement.setAttribute('webkit-playsinline', String(e.playsinline))),
            void 0 !== e.volumn && ((this.config.volumn = e.volumn), (this.mediaElement.volume = this.config.volumn));
          var t = e.muted,
            r = void 0 !== t && t;
          (this.config.muted = r), (this.mediaElement.muted = r);
        }),
              ...
              switch (s.label) {
                case 0:
                  ...
                  return this.url === e && this.container === t
                    ? [2]
                    : (this.mediaElement || ((this.mediaElement = document.createElement('video')), this.mediaElement.setAttribute('x5-video-player-type', 'h5'), this.setConfig(this.config)),
                      this.mediaStream && this.url && this.url === e ? [3, 2] : ((this.url = e), (r = this), [4, this.qnPC.pullStream(this.url, this.config.audioOnly)]));
                case 1:
                  (r.mediaStream = s.sent()), this.setState(w.STATE_READY), (this.mediaElement.srcObject = this.mediaStream), (s.label = 2);
                case 2:
                  return (
                    this.mediaElement &&
                      this.container &&
                      this.mediaElement.parentElement &&
                      this.mediaElement.parentElement !== this.container &&
                      this.mediaElement.parentElement.removeChild(this.mediaElement),
                    (this.container && this.container === t) || ((this.container = t), this.container.appendChild(this.mediaElement)),
                    [
                      2,
                      new Promise(function (e, t) {
                        var r,
                          ...
                          a = setTimeout(function () {
                            n.playerState != w.STATE_IDLE && n.resume().then(e).catch(t);
                          }, b);
                        n.mediaElement.addEventListener('loadedmetadata', function () {
                          clearTimeout(a), n.playerState != w.STATE_IDLE && n.resume().then(e).catch(t);
                        }),
                          (r = function () {
                            return i(n, void 0, void 0, function () {
                              return o(this, function (e) {
                                return this.playerState != w.STATE_IDLE ? [2, this.resume()] : [2];
                              });
                            });
                          }),
                          void 0 === s && (s = 5e3),
                          new Promise(function (e, t) {
                            if ('WeixinJSBridge' in window)
                              ...
                              document.addEventListener(
                                'WeixinJSBridgeReady',
                                function () {
                                  clearTimeout(n), r().then(e).catch(t);
                                },
                                !1
                              );
                            }
        ...
        (t.prototype.resume = function () {
          ...
          return new Promise(function (t, r) {
            if (!e.config) throw new T('config is not initilized, try init() first.', e.playerEmitterId);
            if (!e.mediaElement) throw new T('media is not initialized, try play() first.', e.playerEmitterId);
            e.isPlaying() && t();
            try {
              ...
              n
                ? n
                    .then(function () {
                      e.playerState !== w.STATE_STOP && e.setState(w.STATE_PLAYING), t();
                    })
                    .catch(function (n) {
                      if ('NotAllowedError' === n.name) {
                        var i = 'play fail, ' + n.name + ', ' + n.message;
                        r(new T(i, e.playerEmitterId));
                      } else t();
                    })
                : (e.playerState !== w.STATE_STOP && e.setState(w.STATE_PLAYING), t());
            } catch (t) {
              var i = t instanceof Error ? 'play error, ' + t.name + ', ' + t.message : String(t);
              r(new T(i, e.playerEmitterId));
            }
          });
        }),
        ...
        (t.prototype.muteVideo = function () {
          ...
          t && t.length > 0 ? (this.mediaElement.srcObject = new MediaStream(t)) : (this.mediaElement.srcObject = null), this.resume();
        }),
        (t.prototype.unmuteVideo = function () {
          if (!this.config) throw new T('config is not initilized, try init() first.', this.playerEmitterId);
          if (!this.mediaElement) throw new T('media is not initialized, try play() first.', this.playerEmitterId);
          if (!this.mediaStream) throw new T('mediaStream is empty', this.playerEmitterId);
        ...
        (t.prototype.release = function () {
          if (!this.config) throw new T('config is not initilized, try init() first.', this.playerEmitterId);
          this.setState(w.STATE_IDLE),
            (this.config = void 0),
            this.mediaElement && this.mediaElement.parentElement && this.mediaElement.parentElement.removeChild(this.mediaElement),
            this.qnPC.release(),
            (this.url = void 0),
  ...
  (e.QNRTPlayer = $e), Object.defineProperty(e, '__esModule', { value: !0 });
});
